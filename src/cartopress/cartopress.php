...
if (!class_exists('cartopress')) {
	...
	class cartopress {
		...
		*/
        ...
        //TO DO: Need to prepare GULP with separate ADMIN / CLIENT JS SEPARATION
        ...
        wp_register_script('admin-script', CARTOPRESS_URL . '/admin/js/app.js', array('jquery2.1.4', 'leaflet'), CARTOPRESS_VERS);
